...
import com.venkat.flickr.recycler.ImageAdapter;
import com.venkat.flickr.recycler.OnBottomReachedListener;
import com.venkat.flickr.recycler.RecyclerItemClickListener;
import com.venkat.flickr.tasks.AsyncResponse;
import com.venkat.flickr.tasks.ImageArrayMaker;


import java.util.ArrayList;
import java.util.List;

public class PicturesFragment extends Fragment implements AsyncResponse {
    ...
    private ImageAdapter imageAdapter = new ImageAdapter(Glide.with(getContext()), imageUrls);
